...
(cl:defmethod cl:initialize-instance :after ((m <Course>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Course)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name kingfisher_msgs-msg:<Course> is deprecated: use kingfisher_msgs-msg:Course instead.")))

(cl:ensure-generic-function 'yaw-val :lambda-list '(m))
(cl:defmethod yaw-val ((m <Course>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader kingfisher_msgs-msg:yaw-val is deprecated.  Use kingfisher_msgs-msg:yaw instead.")
  (yaw m))

(cl:ensure-generic-function 'speed-val :lambda-list '(m))
(cl:defmethod speed-val ((m <Course>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader kingfisher_msgs-msg:speed-val is deprecated.  Use kingfisher_msgs-msg:speed instead.")
  (speed m))
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<Course>)))
  ...
  (cl:format cl:nil "# Command an absolute yaw and rate of speed.~%~%# Yaw is specified in radians counter-clockwise from true east.~%float32 yaw~%~%# Speed is specified in meters/s. Negative values correspond to Kingfisher~%# reversing.~%float32 speed~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'Course)))
  "Returns full string definition for message of type 'Course"
  (cl:format cl:nil "# Command an absolute yaw and rate of speed.~%~%# Yaw is specified in radians counter-clockwise from true east.~%float32 yaw~%~%# Speed is specified in meters/s. Negative values correspond to Kingfisher~%# reversing.~%float32 speed~%~%~%"))
